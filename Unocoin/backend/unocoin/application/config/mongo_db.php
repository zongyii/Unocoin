...
$config['mongo_db']['default']['password'] = 'unocoin123';
$config['mongo_db']['default']['database'] = 'unochat';
...
$config['mongo_db']['test']['password'] = 'unocoin123';
$config['mongo_db']['test']['database'] = 'unochat';
